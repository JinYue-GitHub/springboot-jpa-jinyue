package com.goyo.project.bangongshi.web;
...
@RestController
@RequestMapping("/bgsywbgArticle")
public class BGSYWBGArticleController extends CommonDataForArticle {
	    /**
	     * 指定类别查询(显示固定条数)
