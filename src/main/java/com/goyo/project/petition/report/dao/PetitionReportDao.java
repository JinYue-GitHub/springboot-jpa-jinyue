...
@Transactional
public interface PetitionReportDao extends JpaRepository<PetitionReport,String>,JpaSpecificationExecutor<PetitionReport>{
    /**通过typeName信访举报相关信息;*/
	
	 public List<PetitionReport> findByName(String name);
